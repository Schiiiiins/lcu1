...
iC_Gt in0_4    = { 1, -iC_AND, iC_R_FF, 0, "in0_4", &iC_l_[200], &iC_l_[203], &in0_3 };
...
iC_Gt in1_4    = { 1, -iC_AND, iC_R_FF, 0, "in1_4", &iC_l_[221], &iC_l_[224], &in1_3 };
...
iC_Gt in2_4    = { 1, -iC_AND, iC_R_FF, 0, "in2_4", &iC_l_[242], &iC_l_[245], &in2_3 };
...
iC_Gt in3_4    = { 1, -iC_AND, iC_R_FF, 0, "in3_4", &iC_l_[263], &iC_l_[266], &in3_3 };
