...
/* retrieve a string by id from a given string table */
static const char* __init
string_get(struct usb_gadget_strings *tab, u8 id)
{
...
rndis_bind(struct usb_configuration *c, struct usb_function *f)
{
	...
	if (rndis_set_param_vendor(rndis->config, cdev->driver->dev->idVendor, string_get(cdev->driver->strings[0], cdev->driver->dev->iManufacturer)))
		goto fail;
